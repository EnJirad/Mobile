...
function Normal_Land()
        result = gg.alert("🐲 เลือกการเสกของ แพท\n\n: เสกไว มีโอกาสโดนแบนสูงต้องปรับใช้เอง", "เสกปกติ", "เสกไว")
...
function Ice_Land()
    ...
    local Name_Choice = {
        "💠 ใส่โค้ด 4216, 4217, 4218 เอง",
        "🏅 ปั้ม Exp : x2 เหรียญ ปรับเวลา เร็ว x30 ( แนะนำ 4:20 น. )",
        "👑 ปั้ม Exp เร็ว x30 : 🚫 ห้าม โบนัส กับ x2 เหรียญ ( แนะนำ 4:30 น. )",
        "💰 ปั้ม เงิน : x2 เหรียญ ปรับเวลา เร็ว x30 ( แนะนำ 00:13 น. )",
        "💳 ปั้ม เงิน เร็ว x30 : 🚫 ห้าม โบนัส กับ x2 เหรียญ ( แนะนำ 00:08 น. )",
    }
    ...
    elseif selectedType == "🏅 ปั้ม Exp : x2 เหรียญ ปรับเวลา เร็ว x30 ( แนะนำ 4:20 น. )" then
    ...
    elseif selectedType == "👑 ปั้ม Exp เร็ว x30 : 🚫 ห้าม โบนัส กับ x2 เหรียญ ( แนะนำ 4:30 น. )" then
        local Address_Value_1 = "554"
        local Address_Value_2 = "1"
        local Address_Value_3 = "1"
    ...
    elseif selectedType == "💰 ปั้ม เงิน : x2 เหรียญ ปรับเวลา เร็ว x30 ( แนะนำ 00:13 น. )" then
    ...
    elseif selectedType == "💳 ปั้ม เงิน เร็ว x30 : 🚫 ห้าม โบนัส กับ x2 เหรียญ ( แนะนำ 00:08 น. )" then
        local Address_Value_1 = "4117"
...
function Update_script()
    ...
    if result == 1 then
        ...
        print("🙏 ขอบคุณที่สนใจ สคริปต์ ของเรา ✌️")
        print(Admin)
        return
    elseif result == 2 then
        gg.copyText(Discord)
