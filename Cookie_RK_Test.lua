...
function Ice_Land()
    ...
    elseif selectedType == "🏅 ปั้ม Exp : x2 เหรียญ ได้ ( ปรับเวลาหยุดได้ )" then
    ...
    elseif selectedType == "💰 ปั้ม เงิน : x2 เหรียญ ได้ ( ปรับเวลาหยุดได้ )" then
    ...
    elseif selectedType == "💳 ปั้ม เงิน : 🚫 ห้าม x2 เหรียญ ( ปรับเวลาหยุดได้ )" then
        local Address_Value_1 = "4117"
